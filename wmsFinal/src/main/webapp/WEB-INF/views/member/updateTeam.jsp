...
<body>
	...
	<div class="myPage-outer" style="height: 800px;">
        ...
        <div class="team-title">
            ...
            <button style="float: right; background-color: rgb(135, 206, 235); border: 1px solid rgb(135, 206, 235); margin-right: 30px;" class="btn btn-primary " onclick="location.href='battleApplyList.te'">경기신청 관리</button>
        </div>
		<form action="updateTeam.te" method="post"  enctype="multipart/form-data">
            ...
            <div class="team-name">
                ...
                <div class="inputTeamName">
					<input type="text" name="teamName" required value="${ t.teamName }">
                </div>
            </div>
            <div class="sports-name">
                ...
                <div class="inputSportsName">
					<select id="sportsName" name="sportsName"required value="${ t.sportsName }">
                    	<option>축구</option>
                    	<option>야구</option>
                    	<option>농구</option>
                    	<option>탁구</option>
            ...
            <div class="team-intro">
                ...
                <div class="inputTeamIntro">
                    <textarea cols="50" rows="10" style="resize: none;" name="teamIntro" required>${ t.teamIntro }</textarea>
                </div>
            ...
            <div class="team-logo" style="height: 200px;">
                ...
                <img src="${ t.logoChangeName }">
                </div>
                <div class="inputTeamLogoArea">
                    <input type="file" name="reupfile" onchange="setLogo(event)" >
            ...
            <div class="button-area" style="margin-top: 20px;">
                <div class="createButton" style=" text-align: center;">
                    <button type="submit" style="background-color: rgb(135, 206, 235); border: 1px solid rgb(135, 206, 235);" class="btn btn-primary ">수정하기</button>
                </div>
	...
	<script>
        ...
        $(function(){
	        ...
	        function settingSelect(){
	    		...
	    		let selectSportsName = '${t.sportsName}';
	        	
	    		$('#sportsName').val(selectSportsName).prop("selected",true);
